...
$stmt = $dbh->prepare("SELECT * from distribucion_gastosarea where cod_estadoreferencial=1");
$stmt->execute();          
...
$stmt->bindColumn('cod_uo', $codigoUO);
                  ...
                  <?php
                     ...
                     $sum=0;
                      while ($row = $stmt->fetch(PDO::FETCH_BOUND)){
                        ...
                        $nombreUO=nameUnidad($codigoUO);

                  ?>
                    <tr>
                      <td class="text-center"><?= $index; ?></td>
                      <td class="text-left"><?= $nombreUO; ?></td>
