...
try {
    ...
    if ($_POST["codigo"] == 0){
        ...
        bandera_depreciar, cod_unidadorganizacional,cod_area, cod_estadoactivofijo ) values
        ...
        :bandera_depreciar, :cod_unidadorganizacional, :cod_area ,:cod_estadoactivofijo)");
