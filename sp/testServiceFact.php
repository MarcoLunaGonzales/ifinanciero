...
$Objeto_detalle->detalle = "NB/ISO 10075-3:2020";
$Objeto_detalle->precioUnitario = 90;
$Objeto_detalle->cantidad = 1;

$Objeto_detalle2 = new stdClass();
$Objeto_detalle2->suscripcionId = 815;
$Objeto_detalle2->pagoCursoId = 0;
$Objeto_detalle2->detalle = "NB/ISO 10075-3:2020";
$Objeto_detalle2->precioUnitario = 100;
$Objeto_detalle2->cantidad = 3;



$Array= array($Objeto_detalle,$Objeto_detalle2);
