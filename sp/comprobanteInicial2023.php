...
$cod_gestionAnterior=3684;
$cod_gestion=3685;

$gestionInsertar=2022;
$mes_gestion=1;
$glosa="BALANCE INICIAL 2023";

$codComprobante=77942;//obtenerCodigoComprobante(); // IBNORCA: 39843 LOCALHOST: 39084 comprobante INICIAL LA PAZ 
            ...
            while ($row = $stmt4->fetch(PDO::FETCH_BOUND)) {
              ...
              //listar los montos
               ...
               while ($rowComp = $detallesReporte->fetch(PDO::FETCH_ASSOC)) {
                   ...
                   $glosaX="COMPROBANTE INICIAL 2023";
                   $cuentaAuxiliarX=0;
