        ...
        if($row_partidas['tipo_calculo']!=1){
          ...
          $montoCalculado=$precioRegistradoAux2*($porcentPrecios/100);
           ...
           $html.='<tr class="bg-info text-white">'.
                      ...
                      '<td class="text-right font-weight-bold" id="tc1'.$index_titulo.'">'.number_format($montoPresupuestoFila2, 2, '.', ',').'</td>'.
                      '<td class="text-right font-weight-bold" id="tc2'.$index_titulo.'">'.number_format($montoCalculado, 2, '.', ',').'</td>'.
                      '<td class="text-right font-weight-bold" id="tc3'.$index_titulo.'">'.number_format($montoCalculado/$usd, 2, '.', ',').'</td>';
          $html.='</tr>';
         }else{
