	...
	$estado_ibnorca=0;
     ...
     //    }else{	    	
        ...
        // if($cod_comprobante!=0 && $cod_comprobante!=-1){
            ...
            values ('$cod_sucursal','$codigo','$cod_unidadorganizacional','$cod_area',NOW(),'$fecha_limite_emision','$cod_tipoobjeto','$cod_tipopago','$cod_cliente','$cod_personal','$razon_social','$nitCliente','$cod_dosificacionfactura','$nro_correlativo','$nroAutorizacion','$code','$monto_total','$observaciones','1','0','$ci_estudiante')";
            // echo $sql;
