...
<table id="libreta_bancaria_reporte_modal" class="table table-condensed small" style="width:100% !important;">
  <thead>
    <tr style="background:#21618C; color:#fff;">
      ...
      <th class="small bg-success" width="4%">Fecha<br>Asoc.</th>
      <th class="small bg-success" width="3%">N° Fact</th>      
      <th class="small bg-success">Nit</th>
      <th class="small bg-success">Razón Social</th>
      <th class="small bg-success" width="5%">Monto<br>Factura</th>
