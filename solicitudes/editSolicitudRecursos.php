...
$codigo=$_GET['codigo'];
$stmt = $dbh->prepare("SELECT * from simulaciones_costos where codigo=:codigo");
// Ejecutamos
                             ...
                             <div class="form-group">
                                <div class="form-check">
                                    <label class="form-check-label">
                                      <input class="form-check-input" type="checkbox" id="ibnorca_check" <?=($ibnorcaX==1)?"checked":"";?> name="ibnorca_check" value="1">
