			...
			<div class="card">
			  ...
			  <div class="card-body ">
				...
				<div class="row">
				  ...
				  <div class="col-sm-7">
					<div class="form-group">
					  <textarea class="form-control" rows="6" name="mensaje" id="mensaje" placeholder="Escriba aquí su mensaje.."></textarea>
					</div>
				  </div>
				</div>
			  </div>
			  <div class="card-footer fixed-bottom ml-auto mr-auto">
				<button class="btn btn-warning" id="boton_enviocorreo" onclick="enviarCorreoEvento()"><span class="material-icons">mail</span> Enviar</button>
