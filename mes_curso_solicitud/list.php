...
// Preparamos
$stmt = $dbh->prepare("SELECT * from meses_trabajo_solicitudes where cod_gestion='$codGestionGlobal'");
$stmt->execute();
                      ...
                      <?php
                          ...
                          switch ($codEstadoMeses) {
                            ...
                            case 2:                              
                              ...
                              break;
                            case 3:
                              $estiloTipo3="btn btn-success";
                              $estiloTipo1="btn btn-default";
                              $estiloTipo2="btn btn-default";
                              $textStyle="text-success font-weight-bold";                              
                              break;
                            default:                             
                              $estiloTipo1="btn btn-default";
                              $estiloTipo2="btn btn-default";
                        ...
                        <tr>
                          ...
                          <td class="text-right"><a href="<?=$urlSave?>?codigo=<?=$codigo?>&estado=3" class="<?=$estiloTipo3?> btn-sm"><i class="material-icons">lock_open</i><?=$valor3?></a></td>
                          <td class="text-right"><a href="<?=$urlSave?>?codigo=<?=$codigo?>&estado=1" class="<?=$estiloTipo1?> btn-sm"><i class="material-icons">hourglass_top</i> <?=$valor1?></a></td>
                          <td class="text-right"><a href="<?=$urlSave?>?codigo=<?=$codigo?>&estado=2" class="<?=$estiloTipo2?> btn-sm"><i class="material-icons">lock</i> <?=$valor2?></a></td>
                        </tr>
                        <?php
            							$index++;
            						               // }
