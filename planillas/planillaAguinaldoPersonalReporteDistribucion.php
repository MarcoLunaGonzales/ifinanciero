<?php
	...
	// $sql = "SELECT cod_area,(SELECT a.abreviatura from areas a where a.codigo=cod_area) as nombre_area
						...
						// {
							...
							{  
			                	...
			                	<tr>                                                        
				                    ...
				                    <td class="text-left small"><?=$nombre_cargo;?></td>
				                    ...
				                    <td  class="text-center small"><?=$meses_trabajados;?></td>
