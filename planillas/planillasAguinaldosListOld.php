                        ...
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu" role="menu" aria-labelledby="reporte_sueldos">
                            ...
                            <li role="presentation">
                              <a role="item" href="planillas/planillaAguinaldoPersonalReporteDistribucion.php?codigo_planilla=<?=$codigo_planilla;?>&cod_gestion=<?=$cod_gestion;?>" target="_blank">
                                <small>Ver Todo con % Persona</small>
                              </a>
                            </li>
                            <!-- Normal -->
                            <li role="presentation">
