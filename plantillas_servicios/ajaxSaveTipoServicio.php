...
$sql1="SELECT * from plantillas_servicios_tiposervicio where cod_plantillaservicio=$plantilla and cod_claservicio=$codigo";
...
if($existe==0){
    $sql="INSERT INTO plantillas_servicios_tiposervicio (cod_plantillaservicio, cod_claservicio,observaciones,cantidad,monto,cod_estadoreferencial) 
       VALUES ('".$plantilla."','".$codigo."','".$obs."','".$cant."','".$monto."', 1)";
