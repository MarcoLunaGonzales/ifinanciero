...
function obtenerServiciosClaServicioTipo($id,$valor){
  ...
  $sql="";
  if($valor==1){
    $sql="SELECT p.* FROM cla_servicios p join configuraciones_serviciosestado c on p.IdClaServicio=c.IdClaServicio where p.vigente=1 and p.codigo_n2=$id and p.estado=1";
  }else{
