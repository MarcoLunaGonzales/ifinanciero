...
/**
 * Servicio de actualización de Datos Clientes
 */
function wsClienteContacto($idCliente,$razonSocial,$nit,$idTipoDocumento,$idSolicitud){
    ...
    $sql  = "INSERT INTO log_cliente_contacto_upd(cod_solicitudfacturacion,json_enviado,json_recibido,fecha)
            VALUES ($idSolicitud,$json_enviado,$json_recibido,$fechaHora) ";
    $stmt = $dbh->prepare($sql);
    $stmt->execute();
}
