...
<div class="card-body">
  ...
  <div class="table-responsive">
    ...
    $listaDetalle=obtenerListaVentasArea($unidadCostoArray,$areaCostoArray,$desde,$hasta,$solo_credito);
    $totalImporte=0;
    while ($rowComp = $listaDetalle->fetch(PDO::FETCH_ASSOC)) {
        ...
        for($i=0; $i<$longitudUnidades; $i++){
          ...
          $listaDetalleUnidades=obtenerListaVentasArea($unidadCosto[$i],$codAreaX,$desde,$hasta,$solo_credito);
