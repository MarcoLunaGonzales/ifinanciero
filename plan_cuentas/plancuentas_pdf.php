...
$html.=  '<header class="header">'.      
            '<img class="imagen-logo-izq" src="../assets/img/logo_ibnorca_origen_3.jpg">'.      
            '<table width="100%">
              <tr>
              <td width="25%"></td>
              <td><center><span style="font-size: 13px"><b>PLAN DE CUENTAS</b></span></center></td>
  ...
  <tbody>';
    ...
    $html.='<tr>
      ...
      if($cuentaAuxiliar==1){
        ...
        $html.='<td class="text-center" style="color:blue">SI</td>';  
      }else{
