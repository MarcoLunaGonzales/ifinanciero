...
require_once 'conexion.php';
    ...
    $sql="SELECT codigo,direccion_archivo as origen,cod_objeto,descripcion  from archivos_adjuntos where cod_tipopadre!=-2020;";		
    ...
    while ($rowDetalle = $stmt->fetch(PDO::FETCH_ASSOC)) {
       ...
       $ubicacionDestinoNoLeido="ibn_archivos_no_leidos/176/".$nombreArchivo;
       $carpeta="ibn_archivos/176/";
       ...
       if (file_exists($dirCorrecto)) {
          ...
          if (is_readable($dirCorrecto)){
            ...
            $ubicacionDestino="ibn_archivos/176/".$codigoPrevio.$nombreArchivo;
            ...
            VALUES('$codigoFila',176,'$descripcion','','$nombreArchivo','$tipoArchivo','$tamanioArchivo',NOW(),$usuarioRegistro,'-','/$ubicacionDestino')";    
