...
$html.='<html>'.
         '<head>'.
             ...
             #libro_ventas_rep td, #libro_ventas_rep th {
               border: 2px solid;
               padding: 5px;
             }
...
$html.=  '<table width="100%">
              <tr>
              <td width="25%"><p> <strong>Razón Social :</strong> '.$razon_social_titulo.'<br> <strong>Sucursal :</strong> '.$sucursal.'<br> <strong>Nit :</strong> '.$nit.'<br> <strong>Dirección :</strong> '.$direccion.'
                </p></td>
              <td><center><span style="font-size: 13px"><b>Libro de Ventas<br>Periodo: '.$periodoTitle.'<br><em>Expresado en:</em> Bolivianos</b></center></td>
