...
<div class="content">
    ...
    <div style="overflow-y: scroll;">
      <div class="col-md-12">
      <form id="form1" class="form-horizontal" action="reportes/reportesEstadoCuentasPrintMigrar.php" method="post" target="_blank">
      <div class="card">
        <div class="card-header <?=$colorCard;?> card-header-text">
          <div class="card-text">
            <h4 class="card-title">Reporte Estado De Cuentas Para Migrado</h4>
          </div>
          </div>
          <div class="card-body ">
            <div class="row">
