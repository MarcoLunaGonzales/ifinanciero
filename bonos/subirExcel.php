...
<div class="content">
	<div class="container-fluid">
		...
		<div class="col-md-12">
			<form id="form2" class="form-horizontal" action='<?= $urlSubirBonoExcel2; ?>' method="post" enctype="multipart/form-data">
				<div class="card">
					...
					<div class="card-footer ml-auto mr-auto">
						...
						<a href="<?= $urlListMesPersona; ?>&cod_mes=<?= $codMes; ?>&cod_bono=<?= $codBono; ?>" class="<?= $buttonCancel; ?>"> <-- Volver </a>
