...
$sql="SELECT p.codigo, p.numero, p.nombre, p.cod_padre, p.nivel, p.cod_tipocuenta, p.cod_moneda, p.cuenta_auxiliar FROM plan_cuentas_cajachica p where p.codigo='$codigo'";
//  echo $sql;
