...
$query="SELECT numero,MONTH(fecha) as mes,DATE_FORMAT(fecha,'%d/%m/%Y')as fecha_x,glosa from comprobantes where cod_tipocomprobante=$tipo_comprobante and numero=$nro_comprobante and MONTH(fecha)=$mes_comprobante";
// echo $query;
