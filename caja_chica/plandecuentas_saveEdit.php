...
// Prepare
$sql="UPDATE plan_cuentas_cajachica SET numero=:numero, cod_padre=:cod_padre, nombre=:nombre, cod_moneda=:cod_moneda, nivel=:nivel, cod_tipocuenta=:cod_tipocuenta, observaciones=:observaciones, cuenta_auxiliar=:cuenta_auxiliar WHERE codigo=:codigo";
