...
$stmt->execute();
?>
<select name="cod_area" id="cod_area" class="selectpicker form-control" data-style="btn btn-primary" data-show-subtext="true" data-live-search="true" onchange="ajaxAreaCargos(<?=$codigo_UO;?>,this);" >
    <?php 
