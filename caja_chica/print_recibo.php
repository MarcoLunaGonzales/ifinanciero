...
$html.='<body>'.
        ...
        '</script>';
$html.=  '';
       $html.='<div style="padding:15px !important;border:2px solid #000000;border-radius:20px;" ><img class="imagen-logo-izq2" style="position: absolute;padding-top: -2px;left: 30px;top: 20px;width:130px;height:130px;" src="../assets/img/ibnorca2.jpg">'.

             '<div><br>
              <center><h1>RECIBO DE CAJA CHICA</h1></center><center><h2>Of/Area: '.$oficina.'/'.$area.'</h2></center>
