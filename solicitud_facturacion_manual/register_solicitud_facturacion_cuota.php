...
<div class="content">
    <div class="container-fluid">
        <div style="overflow-y:scroll;">
            <div class="col-md-12">
                <form id="formSoliFactTcp" class="form-horizontal" action="solicitud_facturacion_manual/save_solicitud_facturacion_cuotas.php" method="post" onsubmit="return valida(this)" enctype="multipart/form-data">
                    <?php 
                    if(isset($_GET['q'])){?>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body ">
                                ...
                                <fieldset id="fiel" style="width:100%;border:0;">
                                    <button title="Agregar Servicios" type="button" id="add_boton" name="add" class="btn btn-warning btn-round btn-fab" onClick="AgregarSeviciosFacturacion_soli_cuota(this)">
                                        <i class="material-icons">add</i>
                                    </button><span style="color:#084B8A;"><b> SERVICIOS ADICIONALES</b></span>
                                    <div class="row" style="background-color:#1a2748">
                                        <label class="col-sm-2 col-form-label" style="color:#ff9c14; text-align: center">Servicios</label>
                                        <label class="col-sm-1 col-form-label" style="color:#ff9c14; text-align: center">Cant</label>
                                        <label class="col-sm-1 col-form-label" style="color:#ff9c14; text-align: center">Fecha Inicio</label>
                                        <label class="col-sm-1 col-form-label" style="color:#ff9c14; text-align: center">Fecha Fin</label>
