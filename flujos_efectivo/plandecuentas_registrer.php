...
(select count(*) from flujo_efectivo_gruposcuentas pc where c.codigo=pc.cod_plancuenta and pc.cod_flujoefectivogrupo=$cod_fl)as bandera 
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-text">
                  <a href="#">
                    <div class="card-text bg-default btn-orange text-white">
                      <h4 class=""><?=obtenerNombreFlujoEfectivoGrupo($cod_fl)?></h4>
                    </div>
                  </a>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <form id="form_partidaspresupuestariasSR" method="post" action="flujos_efectivo/plandecuentas_save.php">
                      <input type="hidden" id="flujo_grupo" name="flujo_grupo" value="<?=$cod_fl?>">
