...
// Prepare
$stmt = $dbh->prepare("INSERT INTO cuentas_auxiliares_cajachica (nombre, cod_banco, nro_cuenta, direccion, telefono, referencia1, referencia2, cod_estadoreferencial, cod_cuenta) VALUES (:nombre, :cod_banco, :nro_cuenta ,:direccion, :telefono, :referencia1, :referencia2, :cod_estadoreferencial, :cod_cuenta)");
// Bind
