...
$stmt->bindColumn('cod_tipoauxiliar', $codTipoAuxiliar);
$stmt->bindColumn('cod_proveedorcliente', $codProveedorCliente);
...
<?php
                          ...
                          $nombreTipoAuxiliar=nameTipoCuentaAuxiliar($codTipoAuxiliar);
                          $nombreProveedorCliente=nameProveedorCliente($codTipoAuxiliar, $codProveedorCliente);
?>
                        <tr>
