...
try {
    ...
    if ($codigo == 0){
        $stmt = $dbh->prepare("INSERT INTO 
            aportes_patronales(seguro_riesgo_profesional,provivienda,infocal,cns,aporte_patronal_solidario,estado,created_by,modified_by)
             values (:seguro_riesgo_profesional,:provivienda,:infocal,:cns,:aporte_patronal_solidario,:estado,:created_by,:modified_by)");
        //Bind
