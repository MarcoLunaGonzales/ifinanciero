...
$cod_cargo 				= empty($_POST['cod_cargo']) 		? '' : $_POST['cod_cargo'];
$cod_autoridad 			= empty($_POST['cod_autoridad']) 	? '' : $_POST['cod_autoridad'];
$nombre_autoridad 		= empty($_POST['nombre_autoridad']) ? '' : $_POST['nombre_autoridad'];
...
if($cod_estadoreferencial==1){//insertar
	$sql="INSERT INTO cargos_autoridades(cod_cargo,nombre_autoridad,orden,cod_estadoautoridad) values($cod_cargo,'$nombre_autoridad',$orden,$cod_estadoreferencial) ";	
