...
$sql  = "SELECT mae.codigo, mae.cod_etapa, mae.cod_cargo, maes.nombre as nombre_dependiente, c.nombre as cargo_nombre, mae.nombre, mae.descripcion, mae.nro_etapa, mae.estado
        ...
        LEFT JOIN mof_aprobacion_etapas maes ON maes.codigo = mae.cod_etapa
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header <?=$colorCard;?> card-header-icon">
                  ...
                  <h4 class="card-title">Lista de Etapas MOF</h4>
                </div>
                <div class="card-body">
              ...
              ?>
                    ...
                    <a href="?opcion=listaMof" class="btn btn-danger">
...
<script>
  ...
  $("#btnGuardar").click(function() {
      ...
      // PROCESO
      $.ajax({
          url: "rrhh/ajaxMofAprobacionEtapaSave.php",
          method: "POST",
          dataType: "json",
          data: {
            codigo: codigo,
