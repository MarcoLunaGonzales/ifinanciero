...
//$codigo=$codigo;
$stmt = $dbh->prepare("select * from aportes_patronales");
//Ejecutamos;
		  ...
		  <form id="form1" class="form-horizontal" action="<?=$urlSaveaportes_patronales;?>" method="post">
			...
			<div class="card">
			  <div class="card-header <?=$colorCard;?> card-header-text">
				<div class="card-text">
				  <h4 class="card-title"><?php if ($codigo == 0) echo "Registrar"; else echo "Editar";?>  <?=$nombreSingularaportes_patronaless;?></h4>
				</div>
			  </div>
			  <div class="card-body ">
