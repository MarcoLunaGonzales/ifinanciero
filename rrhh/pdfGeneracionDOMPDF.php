<?php
    ...
    // Establece el tamaño de papel y orientación
    $mydompdf->set_paper("A4", "portrait");

    // Renderiza el PDF
    $mydompdf->render();

    // Genera la salida del PDF (por ejemplo, descargarlo o mostrarlo en el navegador)
    $mydompdf->stream('manual_de_cargos.pdf', array('Attachment' => 0));
    exit;
...
class CustomTCPDF extends TCPDF {
    ...
    public function Header() {
        // HTML de la cabecera
        $header = '<table style="border: 1px solid white;">
                    <tr>
                        <td style="border: 1px solid white; width: 80%;">
                            <div class="header-text" style="padding-left: 20px;">
                                ...
                                <h3 class="subtitle gray_soft">PROFESIONAL DE GESTIÓN DE CALIDAD</h3>
                            </div>
                        </td>
