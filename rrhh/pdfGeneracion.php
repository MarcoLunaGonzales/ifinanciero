...
// * Cargo
$sql = "SELECT c.codigo, UPPER(c.nombre) as nombre, c.abreviatura, c.objetivo, c.cod_padre, tc.nombre as nivel_cargo
        FROM cargos c
...
$stmt = $dbh->prepare($sql);
$stmt->execute();
$resp_cargosAreas = $stmt->fetchAll(PDO::FETCH_ASSOC);
