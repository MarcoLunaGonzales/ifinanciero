...
if ($codigo > 0){
    ...
    $codigo=$codigo;    
    $stmt = $dbh->prepare("SELECT * FROM unidades_organizacionales where codigo =:codigo");
    //Ejecutamos;
...
<div class="content">
	<div class="container-fluid">
		...
		<div class="col-md-12">
		  <form id="form1" class="form-horizontal" action="<?=$urlSaveUO;?>" method="post">
  
			<div class="card">
			  <div class="card-header <?=$colorCard;?> card-header-text">
				<div class="card-text">
				  <h4 class="card-title"><?php if ($codigo == 0) echo "Registrar"; else echo "Editar";?>  <?=$nombreSingularUO;?></h4>
				</div>
			  </div>
			  <div class="card-body ">
