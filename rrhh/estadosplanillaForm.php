...
if ($codigo > 0){
    ...
    $codigo=$codigo;
    $stmt = $dbh->prepare("SELECT * FROM estados_planilla where codigo =:codigo");
    //Ejecutamos;
...
<div class="content">
	<div class="container-fluid">
		...
		<div class="col-md-12">
		  <form id="form1" class="form-horizontal" action="<?=$urlSaveEstados_planilla;?>" method="post">
  
			<div class="card">
			  <div class="card-header <?=$colorCard;?> card-header-text">
				<div class="card-text">
				  <h4 class="card-title"><?php if ($codigo == 0) echo "Registrar"; else echo "Editar";?>  <?=$nombreSingularEstadoplanilla;?></h4>
				</div>
			  </div>
			  <div class="card-body ">
