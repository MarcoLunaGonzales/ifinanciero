...
try {
    ...
    if (!empty($codigo)) {
        ...
        $stmt_insertar = $dbh->prepare("INSERT INTO control_versiones (cod_cargo, nro_version, descripcion_cambios, fecha, cod_personal) 
                                       VALUES (:cod_cargo, :nro_version, :descripcion_cambios, :fecha, :cod_personal)");
