...
$stmt = $dbh->prepare("SELECT dgp.codigo as codDistribucion, dgp.cod_unidadorganizacional as codUnidad,
    ...
    <div class="row">
      ...
      <form name="form1" id="form1" action="<?=$urlSaveEditDistribucionGasto;?>" method="POST">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <input type="hidden" name="codigo_distribucion[]"  value="<?=$cod_distribucion;?>"/>
        ...
        ?>
          ...
          <a href='<?= $urlList; ?>'  rel="tooltip" class="<?=$buttonCancel;?>">Cancelar
