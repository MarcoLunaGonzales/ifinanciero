...
$urlRegister="index.php?opcion=registerEscalaAntiguedad";
$urlEdit="index.php?opcion=editEscalaAntiguedad";
$urlDelete="index.php?opcion=deleteEscalaAntiguedad";
$urlSave="escalas_antiguedad/save.php";
$urlSaveEdit="escalas_antiguedad/saveEdit.php";

$urlList2="../index.php?opcion=listEscalaAntiguedad";
