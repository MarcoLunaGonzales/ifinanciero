...
$dbh = new Conexion();
// FACTURA SUSCRIPCIÓN
$sql = "SELECT fv.codigo, fv.nro_factura, sfd.codigo as cod_facturadetalle, fv.fecha_factura, fv.razon_social, fv.nit, vn.Catalogo, vn.idNorma,
        CASE
        ...
        <tbody>
            <?php
                ...
                while ($rowFactura = $stmtFactura->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    $facturaValida = buscarArrayFactura($resultadosFacturaSuscripcion, $rowFactura['codigo']);
