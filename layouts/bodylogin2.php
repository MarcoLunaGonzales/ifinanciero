 ...
 <script>
    $(document).ready(function() {
      ...
      if($("#formRegComp")){
        ...
        Mousetrap.bind('shift+n', function(){ addCuentaContable(); return false; });
        ...
        Mousetrap.bind('shift+a', function(){ $('#modalFile').modal('show'); return false; });
        ...
        Mousetrap.bind('shift+enter', function(){ $(".modal").modal("hide"); return false; });
      }
