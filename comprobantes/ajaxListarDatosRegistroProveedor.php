...
<div class="row">
   ...
   <div class="col-sm-9">
    <div class="form-group">
      <select name="tipo_empresa" id="tipo_empresa" class="form-control form-control-sm selectpicker" data-style="btn btn-primary" required="true" onchange="ajaxTipoProveedorPersonaComprobantes(this)">
  ...
  <div class="row">
   ...
   <div class="col-sm-9">
    <div class="form-group">
      <select name="pais_empresa" id="pais_empresa" onchange="seleccionarDepartamentoServicioComprobantes()" class="form-control form-control-sm selectpicker" data-style="btn btn-info" required="true">
  ...
  <div class="row">
   ...
   <div class="col-sm-9">
    <div class="form-group">
      <select name="departamento_empresa" onchange="seleccionarCiudadServicioComprobantes()" id="departamento_empresa" class="form-control form-control-sm selectpicker" data-style="btn btn-info" required="true">
      </select>
    </div>
   </div>
  </div>
