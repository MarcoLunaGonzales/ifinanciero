...
$un=0;
/*TEMPORAL*/
$stmt = $dbh->prepare("SELECT * FROM facturas_compra f where YEAR(f.fecha)=2024;");
...
c.codigo=cd.cod_comprobante and cd.codigo=e.cod_comprobantedetalle and YEAR(c.fecha)=2024");
