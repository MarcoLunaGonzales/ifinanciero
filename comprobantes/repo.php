      ...
      <?php 
        ...
        while ($row2 = $stmt2->fetch(PDO::FETCH_ASSOC)) {
          ...
          if($codCuenta!=obtieneCuentaPadreAux($codCuentaAux)){
           ...
           $codCuentaAuxPadre='PADRE: '.obtieneCuentaPadreAux($codCuentaAux).' <a href="#" onclick="cambiarCuentaAuxiliarDetalle('.$codCuenta.',1,0,'.$codCompEst.','.$codCuentaAux.','.$codCuentaAuxiliar.')" class="btn btn-sm btn-danger">CA:'.$codCuentaAux.' -> '.$codCuentaAuxiliar.'</a>';
           $nro_erroresauxPadre++;
          }else{
          ...
          if($codCuenta!=obtieneCuentaPadreAux($codCuentaAuxiliar)){
           ...
           $codCuentaAuxiliarPadre='PADRE: '.obtieneCuentaPadreAux($codCuentaAuxiliar).' <a href="#" onclick="cambiarCuentaAuxiliarDetalle('.$codCuenta.',2,'.$codCompDet.',0,'.$codCuentaAuxiliar.','.$codCuentaAux.')" class="btn btn-sm btn-danger">CA:'.$codCuentaAuxiliar.' -> '.$codCuentaAux.'</a>';
              ...
              <?php //if ($estiloAuxiliar!=""){
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href='#' onclick="cambiarCuentaAuxiliarDetalle(<?=$codCuenta?>,1,0,<?=$selCompEst?>,<?=$selCuentaAux?>,<?=$selCuentaAuxiliar?>)" class="dropdown-item">CAMBIAR - COD ESTADO DE CUENTAS</a>
                        <a href='#' onclick="cambiarCuentaAuxiliarDetalle(<?=$codCuenta?>,2,<?=$selCompDet?>,0,<?=$selCuentaAuxiliar?>,<?=$selCuentaAux?>)" class="dropdown-item">CAMBIAR - COD COMPROBANTE DETALLE</a>
                        <a href='#' onclick="cambiarCuentaAuxiliarDetalle(<?=$codCuenta?>,3,0,<?=$selCompEst?>,<?=$selCuentaAux?>,0)" class="dropdown-item">NUEVO - EST</a>
                        <a href='#' onclick="cambiarCuentaAuxiliarDetalle(<?=$codCuenta?>,4,<?=$selCompDet?>,0,<?=$selCuentaAuxiliar?>,0)" class="dropdown-item">NUEVO - COMP</a>
                    </div>
                  </div>
                <?php
              //}
